 ...
 */
class AcasFinalExceptionSubscriber implements EventSubscriberInterface {
   ...
   */
  public function on500Exception(GetResponseForExceptionEvent $event) {
    ...
    $content = $this->t('The Acas Notification website encountered an unexpected error. Please try again later.');
  ...
  public static function getSubscribedEvents() {
    ...
    $events[KernelEvents::EXCEPTION][] = ['on500Exception', -128];
    return $events;
  }
